...
class FlightsTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        flights.append(Flight(number: "LAT1294", leavingAt: "08:30", arrivingAt: "13:50", from: "São Paulo", to: "Goiânia", airline: latam))
        flights.append(Flight(number: "GOL4921", leavingAt: "09:45", arrivingAt: "10:50", from: "Rio de Janeiro", to: "Goiânia", airline: gol))
    }
